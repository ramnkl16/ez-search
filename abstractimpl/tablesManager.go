...
var (
	eqSchema = []common.BleveFieldDef{
		...
		{Name: "retryCount", Type: "numeric", DisplayName: "Retry Count"},
		{Name: "retryDuraition", Type: "numeric", DisplayName: "Retry Duration"},
		{Name: "retryMax", Type: "numeric", DisplayName: "Retry Max"},
		{Name: "message", Type: "text"},
		{Name: "startAt", Type: "date"},
		{Name: "recurringInSeconds", Type: "numeric"},
		{Name: "timeTaken", Type: "numeric"},
